...
class User:
    ...
    def make_invoice(self):
        ...
        self.tree = ttk.Treeview(self.tableframe1, columns=("Transaction ID", "Customer ID", "Product Name",
    ...
    def user_input(self):
       ...
       li=['Customer ID','Product Name','Price','Left Stock']
       va=0
       for i in range(0,4):
