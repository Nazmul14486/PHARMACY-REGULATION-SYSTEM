...
class Main(Login,Admin,User):
    ...
    def buildmain(self):
        ...
        self.topframe=LabelFrame(self.mainw,width=1400,height=120,bg="orange")
        self.topframe.place(x=0,y=0)
        self.store_name = "Pharmacy Regulation"
        self.storelable=Label(self.topframe,text=self.store_name + " System",bg="orange",anchor="center")
